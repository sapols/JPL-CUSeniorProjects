...
public class MarsRover extends Rover {
    ...
    public boolean canTraverse(Coordinate point1, Coordinate point2) {
        try {
            ...
            if((point1height != point2height && !(map.getMapPath()).equals("src/main/resources/mi15S158E.tif")) ||
                    (Math.abs(point1height - point2height) > 6 && (map.getMapPath()).equals("src/main/resources/mi15S158E.tif"))){ //if the heights aren't the same
