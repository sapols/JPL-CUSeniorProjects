...
public class MarsRover extends Rover {
    ...
    public void setCurrentPosition(Coordinate position) { currentPosition = position; }

    public Coordinate getCurrentPosition() { return currentPosition; }

    public void setStartPosition(Coordinate position) { startPosition = position; }

    public Coordinate getStartPosition() { return startPosition; }

    public void setEndPosition(Coordinate position) { endPosition = position; }

    public Coordinate getEndPosition() { return endPosition; }

    public void setXPosition(int x) { currentPosition.setX(x); }

    public int getXPosition() { return currentPosition.getX(); }

    public void setYPosition(int y) { currentPosition.setY(y); }

    public int getYPosition() { return currentPosition.getY(); }
